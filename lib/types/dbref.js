...
exports.loadType = function(mongoose) {
    ...
    DBRef.prototype.ns = function(spec) {
        ...
        switch (typeof spec) {
            ...
            default:
                ...
                this.nsValidator = function(v) {
                    return ~spec.indexOf(v.namespace);
                };
    ...
    DBRef.prototype.cast = function(value, doc, init) {
        ...
        return new dbref(value.collection.name, oid.prototype.cast(value._id), value.db.name);
    };
    ...
    mongoose.SchemaType.DBRef = DBRef;
